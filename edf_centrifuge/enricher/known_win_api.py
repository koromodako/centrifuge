...
GUID = 'known_win_api'
_LOGGER = get_logger('enricher.known_win_api')
_QUERY = '''
SELECT tags FROM centrifuge.known_win_api
WHERE (pattern = false AND api = $1) OR (pattern = true AND $1 LIKE api)
'''
