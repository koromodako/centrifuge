...
GUID = 'known_win_file'
_LOGGER = get_logger('enricher.known_win_file')
_QUERY = '''
SELECT tags FROM centrifuge.known_win_file
WHERE (pattern = false AND filename = $1) OR (pattern = true AND $1 ILIKE filename)
'''
